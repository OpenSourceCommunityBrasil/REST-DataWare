...
BEGIN
  ...
  BEGIN
    FindDirPackage(IncludeTrailingPathDelimiter(SDirRoot) + 'Datasnap\Source', NomePacote);
  END;
  IF NomePacote = 'RESTDriverFD.dpk' THEN
  BEGIN
    FindDirPackage(IncludeTrailingPathDelimiter(SDirRoot) + 'Datasnap\Source\Connectors\FireDAC', NomePacote);
  END;
  IF NomePacote = 'RESTDriverZEOS.dpk' THEN
  BEGIN
    FindDirPackage(IncludeTrailingPathDelimiter(SDirRoot) + 'Datasnap\Source\Connectors\ZEOS', NomePacote);
  END;
  IF NomePacote = 'RESTDriverUniDAC.dpk' THEN
  BEGIN
    FindDirPackage(IncludeTrailingPathDelimiter(SDirRoot) + 'Datasnap\Source\Connectors\UniDAC', NomePacote);
  END;
  ...
  BEGIN
    FindDirPackage(IncludeTrailingPathDelimiter(SDirRoot) + 'CORE\Source\Connectors\FireDAC\Package\Berlin', NomePacote);
  END;

  IF NomePacote = 'RESTDWDriverZEOS.dpk' THEN
  BEGIN
    FindDirPackage(IncludeTrailingPathDelimiter(SDirRoot) + 'CORE\Source\Connectors\ZEOS\Package\Berlin', NomePacote);
  END;
  // Original
...
BEGIN
  ...
  //
  // DATASNAP
  FindDirs(IncludeTrailingPathDelimiter(SDirRoot) + 'Datasnap\Source');
  Copiar('*.dcr');
  Copiar('*.res');
  Copiar('*.dfm');
  Copiar('*.ini');
  ...
  // CORE
  FindDirs(IncludeTrailingPathDelimiter(SDirRoot) + 'CORE\Packages\Delphi\' + PastaDW);
  Copiar('*.dcr');
  Copiar('*.res');
  Copiar('*.dfm');
  Copiar('*.ini');
  Copiar('*.inc');
  FindDirs(IncludeTrailingPathDelimiter(SDirRoot) + 'CORE\Source\Connectors');
  Copiar('*.dcr');
  Copiar('*.res');
  Copiar('*.dfm');
  Copiar('*.ini');
...
BEGIN
  ...
  BEGIN
    ...
    BEGIN
      ...
      AddToLibrarySearchPath(IncludeTrailingPathDelimiter(SDirRoot) + 'Datasnap\Source', BpWin32);
      AddToLibrarySearchPath(IncludeTrailingPathDelimiter(SDirRoot) + 'Datasnap\Source\Connectors\FireDAC', BpWin32);
      AddToLibrarySearchPath(IncludeTrailingPathDelimiter(SDirRoot) + 'Datasnap\Source\Connectors\UniDAC', BpWin32);
      AddToLibrarySearchPath(IncludeTrailingPathDelimiter(SDirRoot) + 'Datasnap\Source\Connectors\ZEOS', BpWin32);
      ...
      AddToLibrarySearchPath(IncludeTrailingPathDelimiter(SDirRoot) + 'Datasnap\Source', BpWin64);
      AddToLibrarySearchPath(IncludeTrailingPathDelimiter(SDirRoot) + 'Datasnap\Source\Connectors\FireDAC', BpWin64);
      AddToLibrarySearchPath(IncludeTrailingPathDelimiter(SDirRoot) + 'Datasnap\Source\Connectors\UniDAC', BpWin64);
      AddToLibrarySearchPath(IncludeTrailingPathDelimiter(SDirRoot) + 'Datasnap\Source\Connectors\ZEOS', BpWin64);
    ...
    IF FrameDpk.RestEasyObjects_dpk.Checked THEN
    BEGIN
      FindDirs(IncludeTrailingPathDelimiter(SDirRoot) + 'CORE\Packages\Delphi\' + PastaDW + '\RestDatawareCORE.dpk', True);
      WITH ODW.Installations[IVersion] DO
      BEGIN
        // AddToLibrarySearchPath(SDirLibrary, bpWin32); // arquivos do projeto ou global (*.pas contidos na uses Library (DCUs) é para qualquer projeto Search apenas para o pacote (PASs))
    ...
    IF FrameDpk.RESTDWDriverZEOS_dpk.Checked THEN
    BEGIN
      AddToLibrarySearchPath(IncludeTrailingPathDelimiter(SDirRoot) + 'CORE\Source\Connectors\ZEOS', BpWin32);
      // AddToLibraryBrowsingPath(IncludeTrailingPathDelimiter(SDirRoot) + 'CORE\Source\Connectors\FireDAC', bpWin32);
      AddToLibrarySearchPath(IncludeTrailingPathDelimiter(SDirRoot) + 'CORE\Source\Connectors\ZEOS', BpWin64);
      // AddToLibrarySearchPath(IncludeTrailingPathDelimiter(SDirRoot) + 'CORE\Source\Connectors\FireDAC', bpOSX32);
    END;
...
BEGIN
  ...
  BEGIN
    ...
    IF MatchText(VersionNumberStr, ['d6', 'd7', 'd14', 'd15', 'd16']) THEN
...
BEGIN
  ...
  BEGIN
    ...
    IF ODW.Installations[IFor].VersionNumberStr = 'd6' THEN
    BEGIN
