object dm: Tdm
  ...
  object zQryFormasPagto: TZQuery
  ...
  object zQryCentroCusto: TZQuery
    Connection = ZConnection
    CachedUpdates = True
    SQL.Strings = (
  ...
  object zQryFornecedores: TZQuery
    Connection = ZConnection
    CachedUpdates = True
    SQL.Strings = (
  ...
  object zQryFuncionarios: TZQuery
    Connection = ZConnection
    CachedUpdates = True
    SQL.Strings = (
  ...
  object zQryTransportadoras: TZQuery
    Connection = ZConnection
    CachedUpdates = True
    SQL.Strings = (
  ...
  object zQryCombustiveis: TZQuery
    Connection = ZConnection
    CachedUpdates = True
    SQL.Strings = (
  ...
  object zQryProdEstoque: TZQuery
    Connection = ZConnection
    CachedUpdates = True
    SQL.Strings = (
  ...
  object zQryCliVeiculos: TZQuery
    Connection = ZConnection
    CachedUpdates = True
    SQL.Strings = (
  ...
  object zQrySeguradoras: TZQuery
    Connection = ZConnection
    CachedUpdates = True
    SQL.Strings = (
  ...
  object zQryOSesServicos: TZQuery
    Connection = ZConnection
    CachedUpdates = True
    SQL.Strings = (
  ...
  object zQryConsultaGeral: TZQuery
    Connection = ZConnection
    CachedUpdates = True
    ReadOnly = True
    Params = <>
  ...
  object zQryContasReceber: TZQuery
    Connection = ZConnection
    CachedUpdates = True
    SQL.Strings = (
      'Select CR.* ,'
  ...
  object zQryPlanoContas: TZQuery
    Connection = ZConnection
    CachedUpdates = True
    SQL.Strings = (
      'Select PC.* '
  ...
  object zQryProdComposicao: TZQuery
    Connection = ZConnection
    CachedUpdates = True
    SQL.Strings = (
  ...
  object zQryComprasPecas: TZQuery
    Connection = ZConnection
    CachedUpdates = True
    SQL.Strings = (
  ...
  object zQryComprasServicos: TZQuery
    Connection = ZConnection
    CachedUpdates = True
    SQL.Strings = (
  ...
  object zQryComprasPagto: TZQuery
    Connection = ZConnection
    CachedUpdates = True
    SQL.Strings = (
  ...
  object zQryHistoricoReceber: TZQuery
    Connection = ZConnection
    CachedUpdates = True
    SQL.Strings = (
  ...
  object zQryContasPagar: TZQuery
    Connection = ZConnection
    CachedUpdates = True
    SQL.Strings = (
      'Select CP.* , '
  ...
  object zQryHistoricoPagar: TZQuery
    Connection = ZConnection
    CachedUpdates = True
    SQL.Strings = (
  ...
  object zQryNFSservicos: TZQuery
    Connection = ZConnection
    CachedUpdates = True
    SQL.Strings = (
  ...
  object zQryECFsServicos: TZQuery
    Connection = ZConnection
    CachedUpdates = True
    SQL.Strings = (
  ...
  object zQryContasPagar_Anexos: TZQuery
    Connection = ZConnection
    CachedUpdates = True
    SQL.Strings = (
      'Select CP.* '
  ...
  object zQryContasReceber_Anexos: TZQuery
    Connection = ZConnection
    CachedUpdates = True
    SQL.Strings = (
      'Select CR.* '
  ...
  object zQryAgendaItens: TZQuery
    Connection = ZConnection
    CachedUpdates = True
    SQL.Strings = (
      'Select  AI.*'
  ...
  object zQryCliDescontos: TZQuery
    Connection = ZConnection
    CachedUpdates = True
    SQL.Strings = (
  ...
  object zQryAcertos_Estoque: TZQuery
    Connection = ZConnection
    CachedUpdates = True
    SQL.Strings = (
  ...
  object zQryAcertos_Estoque_Pecas: TZQuery
    Connection = ZConnection
    CachedUpdates = True
    SQL.Strings = (
      'Select  substring( OP.Descricao from 1 for 45 ) as Peca ,'
  ...
  object zQryTipoSuperficie: TZQuery
    Connection = ZConnection
    CachedUpdates = True
    ReadOnly = True
    SQL.Strings = (
  ...
  object zQryTipoAplicacao: TZQuery
    Connection = ZConnection
    CachedUpdates = True
    ReadOnly = True
    SQL.Strings = (
  ...
  object zQryMeta_Comissao: TZQuery
    Connection = ZConnection
    CachedUpdates = True
    SQL.Strings = (
      'Select * '
  ...
  object zQryTipos_Cheques: TZQuery
    Connection = ZConnection
    CachedUpdates = True
    SQL.Strings = (
  ...
  object zQryTiposReclamacao: TZQuery
    Connection = ZConnection
    CachedUpdates = True
    SQL.Strings = (
  ...
  object zQryContrato_Fornecimento: TZQuery
    Connection = ZConnection
    CachedUpdates = True
    SQL.Strings = (
      'Select E.Descricao as Empresa, OS.* '
  ...
  object zQryContrato_Fornec_Pecas: TZQuery
    Connection = ZConnection
    CachedUpdates = True
    SQL.Strings = (
      'Select  substring( OP.Descricao from 1 for 45 ) as Peca ,'
  ...
  object zQryLimitesdeCredito: TZQuery
    Connection = ZConnection
    CachedUpdates = True
    SQL.Strings = (
      'Select L.*, C.Nome'
  ...
  object zQryProdSeriais: TZQuery
    Connection = ZConnection
    CachedUpdates = True
    SQL.Strings = (
  ...
  object zQryComprasSeriais: TZQuery
    Connection = ZConnection
    CachedUpdates = True
    SQL.Strings = (
  ...
  object zQryContratosPecas: TZQuery
    Connection = ZConnection
    CachedUpdates = True
    SQL.Strings = (
      ''
  ...
  object zQryContratosPagto: TZQuery
    Connection = ZConnection
    CachedUpdates = True
    SQL.Strings = (
      'Select  F.Descricao as Forma_Pagto, OP.Valor, OP.NumDocumento, '
  ...
  object zQryTiposClientes: TZQuery
    Connection = ZConnection
    CachedUpdates = True
    SQL.Strings = (
      'Select * from TiposClientes'
  ...
  object zQryMov_Aparelhos: TZQuery
    Connection = ZConnection
    CachedUpdates = True
    SQL.Strings = (
  ...
  object zQryEspecialidades: TZQuery
    Connection = ZConnection
    CachedUpdates = True
    SQL.Strings = (
  ...
  object zQryFabricantes: TZQuery
    Connection = ZConnection
    CachedUpdates = True
    SQL.Strings = (
  ...
  object zQryOSesSeriais: TZQuery
    Connection = ZConnection
    CachedUpdates = True
    SQL.Strings = (
  ...
  object zQryContratosSeriais: TZQuery
    Connection = ZConnection
    CachedUpdates = True
    SQL.Strings = (
  ...
  object zQryContasRec_Locm: TZQuery
    Connection = ZConnection
    CachedUpdates = True
    SQL.Strings = (
      'Select CR.* '
  ...
  object zQryHistoricoReceber_Locm: TZQuery
    Connection = ZConnection
    CachedUpdates = True
    SQL.Strings = (
  ...
  object zQryContasRec_Locm_Anexos: TZQuery
    Connection = ZConnection
    CachedUpdates = True
    SQL.Strings = (
      'Select CR.* '
  ...
  object zQryAcertos_Precos_Pecas: TZQuery
    Connection = ZConnection
    CachedUpdates = True
    SQL.Strings = (
      'Select  substring( OP.Descricao from 1 for 45 ) as Peca ,'
  ...
  object zQryAcertos_Precos: TZQuery
    Connection = ZConnection
    CachedUpdates = True
    SQL.Strings = (
      'Select E.Descricao as Empresa, OS.* '
  ...
  object zQrySMS_Enviados: TZQuery
    Connection = ZConnection
    CachedUpdates = True
    SQL.Strings = (
      'Select *'
  ...
  object zQryConfere_Estoque_Pecas: TZQuery
    Connection = ZConnection
    CachedUpdates = True
    SQL.Strings = (
      'Select  substring( OP.Descricao from 1 for 45 ) as Peca ,'
  ...
  object zQryConfere_Estoque: TZQuery
    Connection = ZConnection
    CachedUpdates = True
    SQL.Strings = (
      'Select E.Descricao as Empresa, OS.* '
  ...
  object zQryVenda_PorQtde: TZQuery
    Connection = ZConnection
    CachedUpdates = True
    SQL.Strings = (
      'Select * '
  ...
  object zQryGarantias_Cral: TZQuery
    Connection = ZConnection
    CachedUpdates = True
    SQL.Strings = (
      'Select *'
  ...
  object zQryPesquisaDIEF: TZQuery
    Connection = ZConnection
    CachedUpdates = True
    SQL.Strings = (
      'Select * from EMP')
  ...
  object zQrySucatas_Cral: TZQuery
    Connection = ZConnection
    CachedUpdates = True
    SQL.Strings = (
      'Select *'
  ...
  object zQryNFEServicos: TZQuery
    Connection = ZConnection
    CachedUpdates = True
    SQL.Strings = (
  ...
  object zQryMetasVendas: TZQuery
    Connection = ZConnection
    CachedUpdates = True
    SQL.Strings = (
  ...
  object zQryMetasTotais: TZQuery
    Connection = ZConnection
    CachedUpdates = True
    SQL.Strings = (
  ...
  object zQryMetasTotaisMensal: TZQuery
    Connection = ZConnection
    CachedUpdates = True
    SQL.Strings = (
      'Select MT.*, F.Nome as Vendedor '
  ...
  object zQryPromocoesProds: TZQuery
    Connection = ZConnection
    CachedUpdates = True
    SQL.Strings = (
  ...
  object zQryProds_Servs: TZQuery
    Connection = ZConnection
    CachedUpdates = True
    SQL.Strings = (
  ...
  object zQryOSesConferenciaPecas: TZQuery
    Connection = ZConnection
    CachedUpdates = True
    SQL.Strings = (
  ...
  object zQryOSesConferencia: TZQuery
    Connection = ZConnection
    CachedUpdates = True
    SQL.Strings = (
  ...
  object zQryMensagensSMS: TZQuery
    Connection = ZConnection
    CachedUpdates = True
    SQL.Strings = (
  ...
  object zQryParametros_Texto_OS: TZQuery
    Connection = ZConnection
    CachedUpdates = True
    SQL.Strings = (
  ...
  object zQryParametros_Texto_OS2: TZQuery
    Connection = ZConnection
    CachedUpdates = True
    SQL.Strings = (
  ...
  object zQryPlanosTelefonia: TZQuery
    Connection = ZConnection
    CachedUpdates = True
    SQL.Strings = (
      'Select * from TamAros'
