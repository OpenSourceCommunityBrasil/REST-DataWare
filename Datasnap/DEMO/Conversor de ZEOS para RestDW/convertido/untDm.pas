...
type
  Tdm = class(TDataModule)
    ...
    zQryFormasPagto: TRESTClientSQL;
    dsTiposPagto: TDataSource;
    zQryTiposPagto: TRESTClientSQL;
    dsLogin: TDataSource;
    zQryLogin: TRESTClientSQL;
    dsCentroCusto: TDataSource;
    zQryCentroCusto: TRESTClientSQL;
    dsBancos: TDataSource;
    zQryBancos: TRESTClientSQL;
    dsUsuarios: TDataSource;
    zQryUsuarios: TRESTClientSQL;
    dsGrupos: TDataSource;
    zQryGrupos: TRESTClientSQL;
    dsSubGrupos: TDataSource;
    zQrySubGrupos: TRESTClientSQL;
    dsFretes: TDataSource;
    zQryFretes: TRESTClientSQL;
    dsProdForn: TDataSource;
    zQryProdForn: TRESTClientSQL;
    dsProdutos: TDataSource;
    zQryProdutos: TRESTClientSQL;
    dsClientes: TDataSource;
    zQryClientes: TRESTClientSQL;
    dsFornecedores: TDataSource;
    zQryFornecedores: TRESTClientSQL;
    dsFuncionarios: TDataSource;
    zQryFuncionarios: TRESTClientSQL;
    dsCargos: TDataSource;
    zQryCargos: TRESTClientSQL;
    zQryTransportadoras: TRESTClientSQL;
    dsTransportadoras: TDataSource;
    dsMontadoras: TDataSource;
    zQryMontadoras: TRESTClientSQL;
    dsCarros: TDataSource;
    zQryCarros: TRESTClientSQL;
    dsCombustiveis: TDataSource;
    zQryCombustiveis: TRESTClientSQL;
    dsFuracoes: TDataSource;
    zQryFuracoes: TRESTClientSQL;
    dsAros: TDataSource;
    zQryTamAros: TRESTClientSQL;
    dsTipoPneus: TDataSource;
    zQryTipoPneus: TRESTClientSQL;
    dsCustos: TDataSource;
    zQryCustos: TRESTClientSQL;
    dsProdCustos: TDataSource;
    zQryProdCustos: TRESTClientSQL;
    dsEmpresas: TDataSource;
    zQryEmpresas: TRESTClientSQL;
    dsConvenios: TDataSource;
    zQryConvenios: TRESTClientSQL;
    dsProdEstoque: TDataSource;
    zQryProdEstoque: TRESTClientSQL;
    dsProdAplic: TDataSource;
    zQryProdAplic: TRESTClientSQL;
    zQryServicos: TRESTClientSQL;
    dsServicos: TDataSource;
    zQryServCustos: TRESTClientSQL;
    dsServCustos: TDataSource;
    dsParametros: TDataSource;
    zQryParametros: TRESTClientSQL;
    dsASCII: TDataSource;
    zQryASCII: TRESTClientSQL;
    zQryCadGeral: TRESTClientSQL;
    dsCadGeral: TDataSource;
    dsCliVeiculos: TDataSource;
    zQryCliVeiculos: TRESTClientSQL;
    ...
    dsOSes: TDataSource;
    zQryOSes: TRESTClientSQL;
    zQrySeguradoras: TRESTClientSQL;
    dsSeguradoras: TDataSource;
    dsOSesPecas: TDataSource;
    zQryOSesPecas: TRESTClientSQL;
    dsOSesServicos: TDataSource;
    zQryOSesServicos: TRESTClientSQL;
    zQryConsultaGeral: TRESTClientSQL;
    dsConsultaGeral: TDataSource;
    dsOSesPagto: TDataSource;
    zQryOSesPagto: TRESTClientSQL;
    dsSessoes: TDataSource;
    zQrySessoes: TRESTClientSQL;
    dsMarcas: TDataSource;
    zQryMarcas: TRESTClientSQL;
    zQryFunc_Prod: TRESTClientSQL;
    dsFunc_Prod: TDataSource;
    zQryFunc_Serv: TRESTClientSQL;
    ...
    zQryContasReceber: TRESTClientSQL;
    dsContasReceber: TDataSource;
    zQryPlanoContas: TRESTClientSQL;
    dsPlanoContas: TDataSource;
    dsCFOPs: TDataSource;
    zQryCFOPs: TRESTClientSQL;
    dsProdComposicao: TDataSource;
    zQryProdComposicao: TRESTClientSQL;
    dsCompras: TDataSource;
    zQryCompras: TRESTClientSQL;
    dsComprasPecas: TDataSource;
    zQryComprasPecas: TRESTClientSQL;
    dsComprasServicos: TDataSource;
    zQryComprasServicos: TRESTClientSQL;
    dsComprasPagto: TDataSource;
    zQryComprasPagto: TRESTClientSQL;
    zQryHistoricoReceber: TRESTClientSQL;
    dsHistoricoReceber: TDataSource;
    zQryContasPagar: TRESTClientSQL;
    dsContasPagar: TDataSource;
    zQryHistoricoPagar: TRESTClientSQL;
    dsHistoricoPagar: TDataSource;
    zQryMovDia: TRESTClientSQL;
    dsMovDia: TDataSource;
    dsRecibos: TDataSource;
    zQryRecibos: TRESTClientSQL;
    dsProventos: TDataSource;
    zQryProventos: TRESTClientSQL;
    zQryNFSPecas: TRESTClientSQL;
    zQryNFSservicos: TRESTClientSQL;
    dsNFSservicos: TDataSource;
    dsNFSpecas: TDataSource;
    zQryGeral: TRESTClientSQL;
    dsGeral: TDataSource;
    zQryNFsItens: TRESTClientSQL;
    dszQryNFsItens: TDataSource;
    zQryECFs: TRESTClientSQL;
    dsECFs: TDataSource;
    zQryECFsPEcas: TRESTClientSQL;
    zQryECFsServicos: TRESTClientSQL;
    dsECFsServicos: TDataSource;
    dsECFsPecas: TDataSource;
    dsMovFunc: TDataSource;
    zQryMovFunc: TRESTClientSQL;
    dsAvisos: TDataSource;
    zQryAvisos: TRESTClientSQL;
    dsAgenda: TDataSource;
    zQryAgenda: TRESTClientSQL;
    zQryRestricoes: TRESTClientSQL;
    dsRestricoes: TDataSource;
    dsContasPagar_Anexos: TDataSource;
    zQryContasPagar_Anexos: TRESTClientSQL;
    zQryContasReceber_Anexos: TRESTClientSQL;
    dsContasReceber_Anexos: TDataSource;
    zQryAgendaItens: TRESTClientSQL;
    dsAgendaItens: TDataSource;
    dsCliDescontos: TDataSource;
    zQryCliDescontos: TRESTClientSQL;
    ZQuery1: TRESTClientSQL;
    DataSource1: TDataSource;
    dsMovCaixa: TDataSource;
    zQryMovCaixa: TRESTClientSQL;
    zQryCliVeiculosVENDIDO: TStringField;
    zQryCheques: TRESTClientSQL;
    dsCheques: TDataSource;
    dsAcertos_Estoque: TDataSource;
    zQryAcertos_Estoque: TRESTClientSQL;
    dsAcertos_Estoque_Pecas: TDataSource;
    zQryAcertos_Estoque_Pecas: TRESTClientSQL;
    zQryAtualizar: TRESTClientSQL;
    dsAtualizar: TDataSource;
    zQryRotas: TRESTClientSQL;
    dsRotas: TDataSource;
    dsCli_Prod: TDataSource;
    zQryCli_Prod: TRESTClientSQL;
    dsRefCusto: TDataSource;
    zQryRefCusto: TRESTClientSQL;
    zQryTipoUso: TRESTClientSQL;
    dsTipoUso: TDataSource;
    zQryTipoSuperficie: TRESTClientSQL;
    dsTipoSuperficie: TDataSource;
    zQryTipoAplicacao: TRESTClientSQL;
    dsTipoAplicacao: TDataSource;
    dsMovTransf: TDataSource;
    zQryMovTransf: TRESTClientSQL;
    dsMeta_Comissao: TDataSource;
    zQryMeta_Comissao: TRESTClientSQL;
    zQryExtintores: TRESTClientSQL;
    dsExtintores: TDataSource;
    zQryFrota: TRESTClientSQL;
    dsFrota: TDataSource;
    zQryFrotaDesp: TRESTClientSQL;
    dsFrotaDesp: TDataSource;
    dsClassifCli: TDataSource;
    zQryClassifCli: TRESTClientSQL;
    dsTipos_Cheques: TDataSource;
    zQryTipos_Cheques: TRESTClientSQL;
    zQryTiposReclamacao: TRESTClientSQL;
    dsTiposReclamacao: TDataSource;
    zQryPosVenda: TRESTClientSQL;
    dsPosVenda: TDataSource;
    zQryTab_Icms: TRESTClientSQL;
    dsTab_Icms: TDataSource;
    zQryProdLotes: TRESTClientSQL;
    dsProdLotes: TDataSource;
    zQryContrato_Fornecimento: TRESTClientSQL;
    dsContrato_Fornecimento: TDataSource;
    zQryContrato_Fornec_Pecas: TRESTClientSQL;
    dsContrato_Fornec_Pecas: TDataSource;
    dsLimitesdeCredito: TDataSource;
    zQryLimitesdeCredito: TRESTClientSQL;
    zQryProdSeriais: TRESTClientSQL;
    dsProdSeriais: TDataSource;
    zQryProdFotos: TRESTClientSQL;
    dsProdFotos: TDataSource;
    zQryComprasSeriais: TRESTClientSQL;
    dsComprasSeriais: TDataSource;
    zQryMedicos: TRESTClientSQL;
    dsMedicos: TDataSource;
    zQryPacientes: TRESTClientSQL;
    dsPacientes: TDataSource;
    dsContratos: TDataSource;
    zQryContratos: TRESTClientSQL;
    dsContratosPecas: TDataSource;
    zQryContratosPecas: TRESTClientSQL;
    dsContratosPagto: TDataSource;
    zQryContratosPagto: TRESTClientSQL;
    zQryTiposClientes: TRESTClientSQL;
    dsTiposClientes: TDataSource;
    zQryMov_Aparelhos: TRESTClientSQL;
    dsMov_Aparelhos: TDataSource;
    zQryEspecialidades: TRESTClientSQL;
    dsEspecialidades: TDataSource;
    zQryFabricantes: TRESTClientSQL;
    dsFabricantes: TDataSource;
    zQryOSesSeriais: TRESTClientSQL;
    dsOSesSeriais: TDataSource;
    dsContratos_Seriais: TDataSource;
    zQryContratosSeriais: TRESTClientSQL;
    zQryContasRec_Locm: TRESTClientSQL;
    zQryHistoricoReceber_Locm: TRESTClientSQL;
    dsHistoricoReceber_Locm: TDataSource;
    dsContasRec_Locm: TDataSource;
    zQryContasRec_Locm_Anexos: TRESTClientSQL;
    dsContasRec_Locm_Anexos: TDataSource;
    zQryAcertos_Precos_Pecas: TRESTClientSQL;
    zQryAcertos_Precos: TRESTClientSQL;
    dsAcertos_Precos: TDataSource;
    dsAcertos_Precos_Pecas: TDataSource;
    zQrySMS_Enviados: TRESTClientSQL;
    dsSMS_Enviados: TDataSource;
    zQryConfere_Estoque_Pecas: TRESTClientSQL;
    zQryConfere_Estoque: TRESTClientSQL;
    dsConfere_Estoque: TDataSource;
    dsConfere_Estoque_Pecas: TDataSource;
    dsBoletos: TDataSource;
    zQryBoletos: TRESTClientSQL;
    zQryCotacoes: TRESTClientSQL;
    dsCotacoes: TDataSource;
    dsMoedas: TDataSource;
    zQryMoedas: TRESTClientSQL;
    IdFTP_plugin: TIdFTP;
    zQryPromocoes: TRESTClientSQL;
    dsPromocoes: TDataSource;
    zQryVenda_PorQtde: TRESTClientSQL;
    dsVenda_PorQtde: TDataSource;
    IdFTP_netrevenda: TIdFTP;
    zQryGarantias_Cral: TRESTClientSQL;
    dsGarantias_Cral: TDataSource;
    zQryUnidades: TRESTClientSQL;
    dsUnidades: TDataSource;
    zQryEmp: TRESTClientSQL;
    dsEmp: TDataSource;
    zQryPesquisaDIEF: TRESTClientSQL;
    DataSource2: TDataSource;
    zQryIncluiDIEF: TRESTClientSQL;
    DataSource3: TDataSource;
    zQryTabComDia: TRESTClientSQL;
    dsTabComDia: TDataSource;
    zQrySucatas_Cral: TRESTClientSQL;
    dsSucatas_CRAL: TDataSource;
    zQryAidfs: TRESTClientSQL;
    dsAidfs: TDataSource;
    zQryEstagios: TRESTClientSQL;
    dsEstagios: TDataSource;
    zQryBina_Mem: TRESTClientSQL;
    dsBina_Mem: TDataSource;
    zQryCorretores: TRESTClientSQL;
    dsCorretores: TDataSource;
    zQryNFs: TRESTClientSQL;
    dsNFs: TDataSource;
    zQryNFE: TRESTClientSQL;
    dsNFE: TDataSource;
    zQryNFEPecas: TRESTClientSQL;
    dsNFEPecas: TDataSource;
    zQryNFEServicos: TRESTClientSQL;
    dsNFEServicos: TDataSource;
    IdFTP_hostnet: TIdFTP;
    zQryMetasVendas: TRESTClientSQL;
    dsMetasVendas: TDataSource;
    zQryMetasTotais: TRESTClientSQL;
    ...
    zQryMetasTotaisMensal: TRESTClientSQL;
    ...
    zQryNFsDI: TRESTClientSQL;
    dsNFSDi: TDataSource;
    zQryPromocoesProds: TRESTClientSQL;
    ...
    zQryProdRefer: TRESTClientSQL;
    dsProdRefer: TDataSource;
    zQryProds_Servs: TRESTClientSQL;
    dsProds_Servs: TDataSource;
    zQryOSesConferenciaPecas: TRESTClientSQL;
    dsOSesConferenciaPecas: TDataSource;
    zQryOSesConferencia: TRESTClientSQL;
    dsOSesConferencia: TDataSource;
    zQryCores: TRESTClientSQL;
    dsCores: TDataSource;
    zQryMensagensSMS: TRESTClientSQL;
    dsMensagensSMS: TDataSource;
    zQryParametros_Texto_OS: TRESTClientSQL;
    dsParametros_Texto_OS: TDataSource;
    zQryParametros_Texto_OS2: TRESTClientSQL;
    dsParametros_Texto_OS2: TDataSource;
    zQryHistoricos: TRESTClientSQL;
    dsHistoricos: TDataSource;
    zQrySql: TRESTClientSQL;
    zQrySqlECF: TRESTClientSQL;
    zQryContador: TRESTClientSQL;
    zQryContador2: TRESTClientSQL;
    zQryTB_ECF: TRESTClientSQL;
    dsTB_ECF: TDataSource;
    zQryNaturezaOp: TRESTClientSQL;
    dsNaturezaOp: TDataSource;
    zQryNFsPagto: TRESTClientSQL;
    dsNFsPagto: TDataSource;
    dsPlanosTelefonia: TDataSource;
    zQryPlanosTelefonia: TRESTClientSQL;
