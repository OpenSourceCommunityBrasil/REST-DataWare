...
uses
  ...
  uRESTDWComponentBase, uRESTDWComponentEvents, uRESTDWEncodeClass, 
  uRESTDWFileBuffer, uRESTDWMasterDetailData, uRESTDWParams, 
  uRESTDWPoolermethod, uRESTDWResponseTranslator, uRESTDWServerContext, 
  uRESTDWServerEvents, uRESTDWAttachment, uRESTDWAttachmentFile, 
  ...
  uRESTDWDataUtils, uRESTDWException, uRESTDWHeaderCoderBase, 
  ...
  uRESTDWMessageParts, DWDCPbase64, DWDCPblockciphers, DWDCPcast256, 
  DWDCPconst, DWDCPcrypt2, DWDCPrijndael, DWDCPsha256, DWDCPtypes, 
  uRESTDWConsts, StringBuilderUnit, uRESTDWBase64, uRESTDWCharset, 
  ...
  utemplateproglaz, uRESTDWBufferBase, LazarusPackageIntf;
