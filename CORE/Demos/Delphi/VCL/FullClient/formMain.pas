...
Uses
  ...
  Vcl.ComCtrls,
  System.UITypes, IdComponent, uDWConstsData, uDWConstsCharset, System.Actions,
...
Begin
  ...
  DWClientEvents1.SendEvent('getemployee', dwParams, vErrorMessage,
    vNativeResult);
...
Begin
  ...
  Begin
    If DWMassiveCache1.MassiveCount > 0 Then
      RESTDWClientSQL1.DataBase.ApplyUpdates(DWMassiveCache1,
        vResultError, VError);
...
Begin
  ...
  Else
    RESTClientPooler1.TypeRequest := TTyperequest.trHttp;
  DWClientEvents1.SendEvent('assyncevent', dwParams, vErrorMessage,
    sePOST, True);
  If vErrorMessage = '' Then
  Begin
    GetLoginOptionsClientPooler;
...
Begin
  Case cbAuthOptions.ItemIndex Of
    0:
      RESTDWDataBase1.AuthenticationOptions.AuthorizationOption := rdwAONone;
    1:
      RESTDWDataBase1.AuthenticationOptions.AuthorizationOption := rdwAOBasic;
    2:
      RESTDWDataBase1.AuthenticationOptions.AuthorizationOption := rdwAOBearer;
    3:
      RESTDWDataBase1.AuthenticationOptions.AuthorizationOption := rdwAOToken;
  End;
