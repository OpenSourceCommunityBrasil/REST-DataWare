  ...
  Begin
   ...
   Case RESTDWServiceSynPooler1.AuthenticationOptions.AuthorizationOption Of
    rdwAOBasic : Begin
                  ...
                  TRDWAuthOptionBasic(RESTDWServiceSynPooler1.AuthenticationOptions.OptionParams).AuthDialog := cbShowAuthdialog.Checked;
                 End;
    rdwAOBearer,
    rdwAOToken : Begin
                  If RESTDWServiceSynPooler1.AuthenticationOptions.AuthorizationOption = rdwAOBearer Then
                   Begin
                    ...
                    TRDWAuthOptionBearerServer(RESTDWServiceSynPooler1.AuthenticationOptions.OptionParams).AuthDialog      := cbShowAuthdialog.Checked;
                   End
                  Else
                   Begin
                    ...
                    TRDWAuthOptionTokenServer(RESTDWServiceSynPooler1.AuthenticationOptions.OptionParams).AuthDialog      := cbShowAuthdialog.Checked;
                   End;
                 End;
    Else
