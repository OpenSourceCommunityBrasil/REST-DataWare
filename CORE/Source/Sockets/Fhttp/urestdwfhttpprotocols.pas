...
type
  ...
  TReadLnFunction = function: string of object;
  ...
  TRESTDWInterfacedObject = class (TInterfacedObject)
  public
    function _AddRef: Integer;
    function _Release: Integer;
  end;

  THeaderQuotingType = (QuotePlain, QuoteRFC822, QuoteMIME, QuoteHTTP);

  //
  EExtensionAlreadyExists = class(EException);
...
//  procedure BuildMIMETypeMap(dest: TIdStringList);
  ...
  function ContentTypeToEncoding(const AContentType: string; AQuoteType: THeaderQuotingType): IIdTextEncoding;
  ...
  procedure ReadStringsAsContentType(AStream: TStream; AStrings: TStrings;
    const AContentType: String; AQuoteType: THeaderQuotingType
  ...
  procedure WriteStringAsCharset(AStream: TStream; const AStr, ACharset: string
    {$IFDEF STRING_IS_ANSI}; ASrcEncoding: ITextEncoding = nil{$ENDIF});
  ...
  function ReadStringAsCharset(AStream: TStream; const ACharset: String
    {$IFDEF STRING_IS_ANSI}; ADestEncoding: ITextEncoding = nil{$ENDIF}): String;

  procedure ReadStringsAsCharset(AStream: TStream; AStrings: TStrings; const ACharset: string
    {$IFDEF STRING_IS_ANSI}; ADestEncoding: ITextEncoding = nil{$ENDIF});
