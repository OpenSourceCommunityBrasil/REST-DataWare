...
Type
  ...
  {  Property onServerStarted: TOnServerStarted Read vOnServerStarted
   ...
   { Property SSLVersionMin: TSslVerMethod Read vSSLVerMethodMin Write vSSLVerMethodMin default sslVerTLS1_2;
    Property SSLVersionMax: TSslVerMethod Read vSSLVerMethodMax Write vSSLVerMethodMax default sslVerMax;
   ...
   { Property SSLCacheModes: TSslSessCacheModes Read vSSLCacheModes Write vSSLCacheModes;
    ...
    property SelfAssignedCert: TIcsSelfAssignedCert read vIcsSelfAssignedCert write vIcsSelfAssignedCert;
   }
  ...
  {  Property RequestTimeout: Integer Read vServiceTimeout Write vServiceTimeout default 60000; // Connection TimeOut in Milliseconds
   ...
   { procedure SetvIpBlackList(Lines: TStrings);
    ...
    Property BruteForceProtection: TIcsBruteForceProtection read vBruteForceProtection write vBruteForceProtection;
    Property ServerStatusCheck: boolean read vServerStatusCheck write vServerStatusCheck default true;
   }
  End;
...
Begin
  ...
  vSSLUse := false;
  IcsSelfAssignedCert := TIcsSelfAssignedCert.Create;
  }
  vMaxClients := 0;
