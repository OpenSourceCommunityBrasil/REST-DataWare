...
uses
  Windows,
  uRESTDWMemStrings, // must be included before WideStrings
  {$IFDEF COMPILER10_UP}
  WideStrings,
  {$ENDIF COMPILER10_UP}
  ...
  uRESTDWMemJCLUtils,
  {$ENDIF ~COMPILER12_UP}
  uRESTDWMemComponentBase, uRESTDWMemTypes, uRESTDWMemTranslateString,
  IniFiles;
...
uses
  StrUtils,
  uRESTDWMemFileUtils, uRESTDWMemRTTI, uRESTDWMemMime,
  uRESTDWMemConsts, uRESTDWMemResources,
  uRESTDWMemStringsB, uRESTDWMemVCLUtils;
