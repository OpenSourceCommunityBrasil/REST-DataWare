...
uses
  ...
  JclBase, JclStrings;
type
  DelphiHKEY = {$IFDEF CPUX64}type Windows.HKEY{$ELSE}Longword{$ENDIF CPUX64};
...
begin
  ...
  begin
    ...
    // ERRO!!!!!! ARRUMAR ISSO AQUI POIS NÃO FUNCIONA NO LAZARUS!!!!
    Result := true;{RtdlSetNamedSecurityInfoW(WidePath, SE_REGISTRY_KEY,
