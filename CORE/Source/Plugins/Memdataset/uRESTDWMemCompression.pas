...
uses
  ...
  {$ENDIF ZLIB_RTL}
  {$ENDIF ~HAS_UNITSCOPE}
  zlibh, bzip2, uRESTDWMemWideStrings, uRESTDWMemBase, uRESTDWMemStreams;
{$IFDEF RTL230_UP}
...
uses
  ...
  StrUtils,
  {$ENDIF HAS_UNITSCOPE}
  uRESTDWMemUnicode, // WideSameText
  uRESTDWMemDateTime, uRESTDWMemFileUtils, uRESTDWMemResources, uRESTDWMemStrings, uRESTDWMemSysUtils,
  uRESTDWMemAnsiStrings;

const
  RESTDWMemDefaultBufferSize = 131072; // 128k
var
...
begin
  inherited Create;
  FBuffer := nil;
  SetBufferSize(RESTDWMemDefaultBufferSize);
  FStream := AStream;
end;
...
begin
  ...
  GetMem(Buffer, RESTDWMemDefaultBufferSize + 2);
  try
    ...
    begin
      ...
      ReadBytes := SourceStream.Read(Buffer^, RESTDWMemDefaultBufferSize);
      ...
      EofFlag := ReadBytes < RESTDWMemDefaultBufferSize;
    end;
...
begin
  ...
  try
    ...
    begin
      ...
      ReadBytes := DecompressStream.Read(Buffer^, RESTDWMemDefaultBufferSize);
