...
{**********************************************************************}
{}
{ $Log:  16530: SampleType3.pas 
{
{   Rev 1.0    25/2/2003 13:43:32  GGrieve
}
{
...
{$M+}
  ...
  This comment is to test the indent
   ...
   correction built into the parser}
    procedure Sample1(ANum: integer); StdCall; {!Response: Meth1;Request: Meth2; Type: TTestClass1=TestClass4} {&A test comment about Sample1}
    ...
    function Sample5(ANum01: Int64;
      ...
      ANum03: word{!Type: TTestClass1=TestClass5};
      ANum04: byte; {!Type: TTestClass1=TestClass6}
      ANum05: double;
      ACls06: TTestClass;
      AStr07: string;
      AStr08: widestring;
