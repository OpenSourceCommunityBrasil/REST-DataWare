...
{**********************************************************************}
{}
{ $Log:  16528: SampleType2.pas 
{
{   Rev 1.0    25/2/2003 13:43:28  GGrieve
}
{
...
{$M+}
  ...
  This comment is to test the indent
   ...
   correction built into the parser}
    procedure Sample1(ANum: integer); StdCall; {!Response: Meth1;Request: Meth2; Encoding: RPC} {&A test comment about Sample1}
