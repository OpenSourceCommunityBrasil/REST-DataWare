...
{**********************************************************************}
{}
{ $Log:  16520: SampleDefn.pas 
{
{   Rev 1.0    25/2/2003 13:43:08  GGrieve
}
{
...
{$M+}
  IIdTestInterface = interface(IIdSoapInterface)
    ['{F136E09D-85CC-45FC-A525-5322D323E54F}']
      {!Namespace: http://www.kestral.com.au/test/namespace-namespace; soapACTION: http://sdfsdf/sdfsd.sdf/sdf; Session: Required}
  ...
  This comment is to test the indent
   ...
   correction built into the parser}
    ...
    function Sample5(ANum01: Int64;
      ...
      AOrd15: TEnumeration;
      AOrd16: boolean;
      ANum17: TMyInteger): Integer; StdCall; {! Request : Meth3  ;Response:Meth4; SoapAction : http://sdfsdf/sdfsd.sdf/sdf2; Session: Not Required; }
