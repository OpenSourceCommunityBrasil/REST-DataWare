...
{$IFDEF FPC}
  ...
  uRESTDWBasic, uRESTDWBasicDB, uRESTDWConsts, uRESTDWComponentEvents,
  uRESTDWBasicTypes, uRESTDWJSONObject,
  uRESTDWParams, uRESTDWBasicClass, uRESTDWEncodeClass, uRESTDWCharset,
  uRESTDWAbout
{$ELSE}
{$IF CompilerVersion <= 22}
  SysUtils, Classes, Db, Variants, EncdDecd, SyncObjs, uRESTDWComponentEvents,
  uRESTDWBasicTypes, uRESTDWJSONObject,
  uRESTDWBasic, uRESTDWBasicDB, uRESTDWParams, uRESTDWMassiveBuffer,
  uRESTDWBasicClass, uRESTDWAbout
{$ELSE}
  System.SysUtils, System.Classes, Data.Db, Variants, System.SyncObjs,
  uRESTDWComponentEvents, uRESTDWBasicTypes, uRESTDWJSONObject,
...
{$ENDIF}
    , uRESTDWTools, uRESTDWDataUtils

    ;

Type
  TRESTDWSynServicePooler = Class(TRESTServicePoolerBase)
  Private
...
{$ENDIF});
  ...
  Published
//    Property SSLPrivateKeyFile: String Read ASSLPrivateKeyFile
//      Write ASSLPrivateKeyFile;
//    Property SSLPrivateKeyPassword: String Read ASSLPrivateKeyPassword
//      Write ASSLPrivateKeyPassword;
//    Property SSLCertFile: String Read ASSLCertFile Write ASSLCertFile;
//    Property SSLRootCertFile: String Read vaSSLRootCertFile
//      Write vaSSLRootCertFile;
//    Property SSLVerifyMode: TIdSSLVerifyModeSet Read vSSLVerifyMode
//      Write vSSLVerifyMode;
...
Type
  ...
  Private
    ...
    Procedure pOnWork(ASender: TObject; AWorkMode: TWorkMode;
      AWorkCount: Int64);
    ...
    Procedure pOnStatus(ASender: TObject; Const AStatus: TIdStatus;
...
{$IFNDEF DELPHI_10TOKYO_UP}
    ...
    Function IdSSLIOHandlerSocketOpenSSL1VerifyPeer(Certificate: TIdX509;
      AOk: Boolean; ADepth: Integer): Boolean; Overload;
{$ENDIF}
{$ENDIF}
    Function IdSSLIOHandlerSocketOpenSSL1VerifyPeer(Certificate: TIdX509;
      AOk: Boolean; ADepth, AError: Integer): Boolean; Overload;
  Public
    Constructor Create(AOwner: TComponent); Override;
    Destructor Destroy; Override;
    ...
    Function Post(AUrl: String = ''; CustomHeaders: TStringList = Nil;
      Const CustomBody: TStream = Nil; IgnoreEvents: Boolean = False;
    ...
    Function Post(AUrl: String = ''; CustomHeaders: TStringList = Nil;
      FileName: String = ''; FileStream: TStream = Nil;
      Const AResponse: TStream = Nil; IgnoreEvents: Boolean = False;
      RawHeaders: Boolean = False): Integer; Overload; Override;
    Function Post(AUrl: String; var AResponseText: String;
      CustomHeaders: TStringList = Nil; CustomParams: TStringList = Nil;
      Const CustomBody: TStream = Nil; Const AResponse: TStream = Nil;
      IgnoreEvents: Boolean = False; RawHeaders: Boolean = False): Integer;
      Overload; Override;
    Function Post(AUrl: String; CustomHeaders: TStringList = Nil;
      CustomParams: TStringList = Nil; FileName: String = '';
      FileStream: TStream = Nil; Const AResponse: TStream = Nil;
      IgnoreEvents: Boolean = False; RawHeaders: Boolean = False): Integer;
      Overload; Override;
    Function Put(AUrl: String = ''; CustomHeaders: TStringList = Nil;
      Const AResponse: TStream = Nil; IgnoreEvents: Boolean = False): Integer;
      Overload; Override;
    Function Put(AUrl: String = ''; CustomHeaders: TStringList = Nil;
      Const CustomBody: TStream = Nil; Const AResponse: TStream = Nil;
    ...
    Function Put(AUrl: String = ''; CustomHeaders: TStringList = Nil;
      ...
      Overload; Override;
    Function Put(AUrl: String = ''; CustomHeaders: TStringList = Nil;
      CustomParams: TStringList = Nil; Const CustomBody: TStream = Nil;
      Const AResponse: TStream = Nil; IgnoreEvents: Boolean = False): Integer;
      Overload; Override;
    Function Put(AUrl: String = ''; CustomHeaders: TStringList = Nil;
      CustomParams: TStringList = Nil; FileName: String = '';
      FileStream: TStream = Nil; Const AResponse: TStream = Nil;
      IgnoreEvents: Boolean = False): Integer; Overload; Override;
    Function Patch(AUrl: String = ''; CustomHeaders: TStringList = Nil;
      Const AResponse: TStream = Nil; IgnoreEvents: Boolean = False): Integer;
      Overload; Override;
    Function Patch(AUrl: String = ''; CustomHeaders: TStringList = Nil;
      CustomBody: TStream = Nil; Const AResponse: TStream = Nil;
      IgnoreEvents: Boolean = False): Integer; Overload; Override;
    Function Patch(AUrl: String = ''; CustomHeaders: TStringList = Nil;
      CustomParams: TStringList = Nil; CustomBody: TStream = Nil;
      Const AResponse: TStream = Nil; IgnoreEvents: Boolean = False): Integer;
      Overload; Override;
    Function Patch(AUrl: String = ''; CustomHeaders: TStringList = Nil;
      CustomParams: TStringList = Nil; FileName: String = '';
      FileStream: TStream = Nil; Const AResponse: TStream = Nil;
      IgnoreEvents: Boolean = False): Integer; Overload; Override;
    Function Delete(AUrl: String = ''; CustomHeaders: TStringList = Nil;
      Const AResponse: TStream = Nil; IgnoreEvents: Boolean = False): Integer;
      Overload; Override;
    Function Delete(AUrl: String; CustomHeaders: TStringList = Nil;
      CustomParams: TStringList = Nil; Const AResponse: TStream = Nil;
      IgnoreEvents: Boolean = False): Integer; Overload; Override;
  Published
    ...
    Property OnGetpassword: TOnGetpassword Read vOnGetpassword
      Write vOnGetpassword;
  End;
...
Type
  ...
  Private
    ...
    Function SendEvent(EventData: String; Var Params: TRESTDWParams;
      EventType: TSendEvent = sePOST; JsonMode: TJsonMode = jmDataware;
      ServerEventName: String = ''; Assyncexec: Boolean = False)
      : String; Override;
    Procedure SetParams(TransparentProxy: TProxyConnectionInfo;
      aRequestTimeout, aConnectTimeout: Integer;
      AuthorizationParams: TRESTDWClientAuthOptionParams);
  Public
    ...
    Procedure ReconfigureConnection(Var Connection: TRESTClientPoolerBase;
      aTypeRequest: Ttyperequest; aWelcomeMessage, aHost: String;
      APort: Integer; Compression, EncodeStrings: Boolean;
      aEncoding: TEncodeSelect; aAccessTag: String;
    ...
    Begin
      ...
      Begin
        ...
        temp := TStringStream.Create
          (E.ErrorMessage{$IFNDEF FPC}{$IF CompilerVersion > 21},
          TEncoding.UTF8{$IFEND}{$ENDIF});
  ...
  Except
    ...
    Begin
      ...
      Begin
        ...
        Else
          temp := TStringStream.Create
            (E.Message{$IFNDEF FPC}{$IF CompilerVersion > 21},
            TEncoding.UTF8{$IFEND}{$ENDIF});
        temp.Free;
      End;
    End;
...
Function TRESTDWIdClientREST.Post(AUrl: String = '';
  CustomHeaders: TStringList = Nil; FileName: String = '';
  FileStream: TStream = Nil; Const AResponse: TStream = Nil;
  IgnoreEvents: Boolean = False; RawHeaders: Boolean = False): Integer;
Var
  temp: TStringStream;
...
{$ENDIF}
    ...
    Try
      ...
      Begin
        ...
        SendParams.AddFormField('upload_file', 'application/octet-stream', '',
          FileStream, FileName);
      End;
      If Not Assigned(AResponse) Then
      Begin
...
Function TRESTDWIdClientREST.Post(AUrl: String; Var AResponseText: String;
  CustomHeaders: TStringList = Nil; CustomParams: TStringList = Nil;
  Const CustomBody: TStream = Nil; Const AResponse: TStream = Nil;
  IgnoreEvents: Boolean = False; RawHeaders: Boolean = False): Integer;
Var
...
Var
  ...
  temp: TStringStream;
  vTempHeaders: TStringList;
  atempResponse, tempResponse, SendParams: TStringStream;
Begin
  Result := 200;
  Try
    tempResponse := Nil;
...
{$IF CompilerVersion > 26} // Delphi XE6 pra cima
        ...
        Begin
          If SendParams.Size = 0 Then
            TIdHTTPAccess(HttpRequest).DoRequest(Id_HTTPMethodPatch, AUrl, temp,
              atempResponse, [])
          Else
            TIdHTTPAccess(HttpRequest).DoRequest(Id_HTTPMethodPatch, AUrl,
              SendParams, atempResponse, []);
        End
        Else
          TIdHTTPAccess(HttpRequest).DoRequest(Id_HTTPMethodPatch, AUrl, temp,
            atempResponse, []);
...
{$ENDIF}
      ...
      Else
      Begin
        temp := TStringStream.Create(StringReplace(vTempHeaders.Text,
...
Function TRESTDWIdClientREST.Patch(AUrl: String = '';
  CustomHeaders: TStringList = Nil; CustomBody: TStream = Nil;
  Const AResponse: TStream = Nil; IgnoreEvents: Boolean = False): Integer;
Var
  temp: TStringStream;
  vTempHeaders: TStringList;
...
Var
  vTempHeaders: TStringList;
  temp, atempResponse, tempResponse, SendParams: TStringStream;
  aString: String;
Begin
  Result := 200;
  Try
...
{$ELSE}
      TIdHTTPAccess(HttpRequest).DoRequest(Id_HTTPMethodDelete, AUrl,
        SendParams, atempResponse, []);
{$ENDIF}
{$ENDIF}
      Result := HttpRequest.ResponseCode;
...
Begin
  Result := IdSSLIOHandlerSocketOpenSSL1VerifyPeer(Certificate, AOk,
    ADepth, -1);
End;
{$ENDIF}
{$ENDIF}
...
Procedure TRESTDWIdClientREST.pOnWork(ASender: TObject; AWorkMode: TWorkMode;
  AWorkCount: Int64);
Begin
  ...
  Begin
    ...
    Begin
      ...
      Begin
        If SendParams = Nil Then
        Begin
          If (AHeaders.Names[I] <> '') Or
            (AHeaders.ValueFromIndex[I] <> '') Then
          Begin
            If RequestCharset = esUtf8 Then
              HttpRequest.Request.CustomHeaders.AddValue(AHeaders.Names[I],
...
{$IFNDEF FPC}
{$IF CompilerVersion > 21}
      SendParams.AddFormField('Access-Control-Allow-Origin',
        AccessControlAllowOrigin);
{$ELSE}
      SendParams.AddFormField('Access-Control-Allow-Origin',
        AccessControlAllowOrigin);
...
{$ENDIF}
  ...
  If (AuthenticationOptions.AuthorizationOption in [rdwAOBearer,
    rdwAOToken]) Then
    HttpRequest.Request.CustomHeaders.FoldLines := False;
  If AccessControlAllowOrigin <> '' Then
  Begin
...
{$ENDIF}
  ...
  Begin
    ...
    End;
  End;
  If AuthenticationOptions.AuthorizationOption in [rdwAOBasic, rdwAOBearer,
    rdwAOToken, rdwOAuth] Then
  Begin
    HttpRequest.Request.BasicAuthentication :=
    ...
    Case AuthenticationOptions.AuthorizationOption of
      rdwAOBasic:
        Begin
          If HttpRequest.Request.Authentication = Nil Then
            HttpRequest.Request.Authentication := TIdBasicAuthentication.Create;
          HttpRequest.Request.Authentication.Password :=
            TRESTDWAuthOptionBasic(AuthenticationOptions.OptionParams).Password;
          HttpRequest.Request.Authentication.Username :=
            TRESTDWAuthOptionBasic(AuthenticationOptions.OptionParams).Username;
        End;
      rdwAOBearer:
        Begin
          ...
          End;
          HttpRequest.Request.CustomHeaders.Add('Authorization: Bearer ' +
      ...
      rdwAOToken:
        Begin
          ...
          Begin
            ...
            HttpRequest.Request.Authentication := Nil;
          End;
          HttpRequest.Request.CustomHeaders.Add('Authorization: Token ' +
            Format('token="%s"',
      ...
      rdwOAuth:
        Begin
          ...
          Begin
            ...
            HttpRequest.Request.Authentication := Nil;
          End;
          ActiveRequest := StringReplace(lowercase(ActiveRequest), 'http://',
            '', [rfReplaceAll]);
          ActiveRequest := StringReplace(lowercase(ActiveRequest), 'https://',
            '', [rfReplaceAll]);
          TRESTDWDataUtils.ParseRESTURL(ActiveRequest, RequestCharset,
            vmark{$IFDEF FPC}, csUndefined{$ENDIF}, DWParams);
          ...
          Case TRESTDWAuthOAuth(AuthenticationOptions.OptionParams).TokenType Of
            rdwOATBasic:
              Begin
                If TRESTDWAuthOAuth(AuthenticationOptions.OptionParams)
                  .AutoBuildHex Then
                  HttpRequest.Request.CustomHeaders.Add
                    (Format('Authorization: Basic %s',
                    [EncodeStrings(TRESTDWAuthOAuth
                    (AuthenticationOptions.OptionParams).ClientID + ':' +
                    TRESTDWAuthOAuth(AuthenticationOptions.OptionParams)
                    .ClientSecret
{$IFDEF FPC}, csUndefined{$ENDIF})]))
                Else
                  HttpRequest.Request.CustomHeaders.Add
...
{$IFDEF FPC}, csUndefined{$ENDIF})]));
            ...
            rdwOATBearer:
              HttpRequest.Request.CustomHeaders.Add('Authorization: Bearer ' +
                TRESTDWAuthOAuth(AuthenticationOptions.OptionParams).Token);
            rdwOATToken:
              HttpRequest.Request.CustomHeaders.Add('Authorization: Token ' +
                Format('token="%s"',
                [TRESTDWAuthOAuth(AuthenticationOptions.OptionParams).Token]));
...
Procedure TRESTDWIdServicePooler.aCommandGet(AContext: TIdContext;
  ARequestInfo: TIdHTTPRequestInfo; AResponseInfo: TIdHTTPResponseInfo);
Var
  sCharSet, vToken, ErrorMessage, vAuthRealm, vResponseString: String;
...
{$IFNDEF FPC}
    mb := TStringStream.Create
      (ErrorMessage{$IFNDEF FPC}{$IF CompilerVersion > 21},
      TEncoding.UTF8{$IFEND}{$ENDIF});
    mb.Position := 0;
    ...
    Begin
      ...
      Begin
        For I := 0 To CORS_CustomHeaders.Count - 1 Do
          AResponseInfo.CustomHeaders.AddValue(CORS_CustomHeaders.Names[I],
...
{$IF Defined(HAS_FMX)}
{$IFDEF HAS_UTF8}
    If Assigned({$IF CompilerVersion > 33}AContext.Data{$ELSE}AContext.
      DataObject{$IFEND}) Then
      vToken := TRESTDWAuthRequest
        ({$IF CompilerVersion > 33}AContext.Data{$ELSE}AContext.
        DataObject{$IFEND}).Token;
{$ELSE}
...
{$ENDIF}
    ...
    If CommandExec(TComponent(AContext),
      RemoveBackslashCommands(ARequestInfo.URI), ARequestInfo.RawHTTPCommand,
      ARequestInfo.ContentType, AContext.Binding.PeerIP, ARequestInfo.UserAgent,
      ARequestInfo.Username, ARequestInfo.Password, vToken,
      ARequestInfo.CustomHeaders, AContext.Binding.PeerPort,
      ARequestInfo.RawHeaders, ARequestInfo.Params, ARequestInfo.QueryParams,
      ARequestInfo.PostStream, vAuthRealm, sCharSet, ErrorMessage, StatusCode,
...
{$ENDIF}
  ...
  Begin
    ...
    If AuthenticationOptions.AuthorizationOption
...
{$IF Not Defined(HAS_FMX)}
  If (lowercase(AAuthType) = lowercase('bearer')) Or
    (lowercase(AAuthType) = lowercase('token')) And (AContext.Data = Nil) Then
  Begin
    vAuthValue := TRESTDWAuthOAuth.Create;
    vAuthValue.Token := AAuthType + ' ' + AAuthData;
    AContext.Data := vAuthValue;
    VHandled := AuthenticationOptions.AuthorizationOption
      In [rdwAOBearer, rdwAOToken];
  End;
{$ELSE}
{$IFDEF HAS_UTF8}
  If (lowercase(AAuthType) = lowercase('bearer')) Or
...
Procedure TRESTDWIdServicePooler.GetSSLPassWord(var Password:
...
Procedure TRESTDWIdClientPooler.SetParams(TransparentProxy
  : TProxyConnectionInfo; aRequestTimeout: Integer; aConnectTimeout: Integer;
  AuthorizationParams: TRESTDWClientAuthOptionParams);
Begin
...
Procedure TRESTDWIdClientPooler.ReconfigureConnection(Var Connection
  : TRESTClientPoolerBase; aTypeRequest: Ttyperequest;
...
Function TRESTDWIdClientPooler.SendEvent(EventData: String;
  Var Params: TRESTDWParams; EventType: TSendEvent; JsonMode: TJsonMode;
  ServerEventName: String; Assyncexec: Boolean): String;
Var
  vErrorMessage, vErrorMessageA, vDataPack, SResult, vURL, vResponse,
    vTpRequest: String;
  I: Integer;
  vDWParam: TJSONParam;
  MemoryStream, vResultParams: TStringStream;
  aStringStream, bStringStream, StringStream: TStream;
  SendParams: TIdMultipartFormDataStream;
...
{$ELSE}
        ...
        // Correção para Delphi's Antigos de Charset.
{$IFEND}
{$ENDIF}
      End
      Else
    ...
    Try
      ...
      If (Params <> Nil) And (InputValue <> '{"PARAMS"]}') And
        (InputValue <> '') Then
      Begin
{$IFDEF FPC}
          ...
          Begin
            ...
            Begin
              ...
              Try
                ...
                JSONParam.ObjectDirection :=
                  GetDirectionName(bJsonOBJ.pairs[1].Value);
                JSONParam.Encoded :=
                  GetBooleanFromString(bJsonOBJ.pairs[2].Value);
                If Not(JSONParam.ObjectValue In [ovBlob, ovStream, ovGraphic,
                  ovOraBlob, ovOraClob]) Then
                Begin
                  If (JSONParam.Encoded) Then
                  Begin
{$IFDEF FPC}
                    vValue := DecodeStrings(bJsonOBJ.pairs[4].Value{$IFDEF FPC},
                      DatabaseCharSet{$ENDIF});
{$ELSE}
                      vValue := DecodeStrings
                      (bJsonOBJ.pairs[4].Value{$IFDEF FPC},
                      vDatabaseCharSet{$ENDIF});
{$IF CompilerVersion < 21}
                    If Encoding = esUtf8 Then
...
{$ENDIF}
                ...
                End
                Else If Not(ParamsData.ItemsString[JSONParam.ParamName]
                  .Binary) Then
                  ParamsData.ItemsString[JSONParam.ParamName].Value :=
                    JSONParam.Value
                Else
    ...
    End;
  End;
  Function GetParamsValues(Var DWParams: TRESTDWParams{$IFDEF FPC};
    vDatabaseCharSet: TDatabaseCharSet{$ENDIF}): String;
  Var
    I: Integer;
  Begin
    Result := '';
    ...
    If WelcomeMessage <> '' Then
      Result := 'dwwelcomemessage=' + EncodeStrings(WelcomeMessage{$IFDEF FPC},
        vDatabaseCharSet{$ENDIF});
    If AccessTag <> '' Then
    Begin
      If Result <> '' Then
        Result := Result + '&dwaccesstag=' +
          EncodeStrings(AccessTag{$IFDEF FPC}, vDatabaseCharSet{$ENDIF})
      Else
        Result := 'dwaccesstag=' + EncodeStrings(AccessTag{$IFDEF FPC},
          vDatabaseCharSet{$ENDIF});
    End;
    ...
    Begin
      ...
      Begin
        ...
        Finally
          If Result <> '' Then
            Result := Result + '&dwservereventname=' +
              EncodeStrings(JSONValue.ToJSON{$IFDEF FPC},
              vDatabaseCharSet{$ENDIF})
          Else
            Result := 'dwservereventname=' +
              EncodeStrings(JSONValue.ToJSON{$IFDEF FPC},
              vDatabaseCharSet{$ENDIF});
          FreeAndNil(JSONValue);
        End;
    ...
    Begin
      ...
      Begin
        If Result <> '' Then
        Begin
          If DWParams.Items[I].ObjectValue in [ovSmallint, ovInteger, ovWord,
            ovBoolean, ovByte, ovAutoInc, ovLargeint, ovLongWord, ovShortint,
            ovSingle] Then
            Result := Result + Format('&%s=%s', [DWParams.Items[I].ParamName,
          ...
          Begin
            ...
            Else
              Result := Result + Format('&%s=%s', [DWParams.Items[I].ParamName,
                EncodeStrings(DWParams.Items[I].Value{$IFDEF FPC},
                vDatabaseCharSet{$ENDIF})]);
          End;
        End
        Else
  ...
  Procedure SetParamsValues(DWParams: TRESTDWParams;
    SendParamsData: TIdMultipartFormDataStream);
  Var
    I: Integer;
    vCharsset: String;
  Begin
...
{$ELSE}
        MemoryStream := TStringStream.Create(''{$IF CompilerVersion > 21},
...
{$IFNDEF FPC}
{$IF (DEFINED(OLDINDY))}
            SendParamsData.AddObject('binarydata', 'application/octet-stream',
              MemoryStream);
            // StringStreamList.Items[StringStreamList.Count-1]);
{$ELSE}
            SendParamsData.AddObject('binarydata', 'application/octet-stream',
              '', MemoryStream);
            // StringStreamList.Items[StringStreamList.Count-1]);
...
{$ENDIF}
      ...
      Begin
        ...
        For I := 0 To DWParams.Count - 1 Do
        Begin
          If DWParams.Items[I].ObjectValue in [ovWideMemo, ovBytes, ovVarBytes,
            ovBlob, ovStream, ovMemo, ovGraphic, ovFmtMemo, ovOraBlob,
            ovOraClob] Then
          Begin
            StringStreamList.Add({$IFDEF FPC}
              TStringStream.Create(DWParams.Items[I].ToJSON)
{$ELSE}
              TStringStream.Create(DWParams.Items[I]
              .ToJSON{$IF CompilerVersion > 21}, TEncoding.UTF8{$IFEND})
{$ENDIF});
{$IFNDEF FPC}
{$IF CompilerVersion > 21}
            SendParamsData.AddObject(DWParams.Items[I].ParamName,
              'multipart/form-data', vCharsset,
              StringStreamList.Items[StringStreamList.Count - 1]);
{$ELSE}
{$IF (DEFINED(OLDINDY))}
            SendParamsData.AddObject(DWParams.Items[I].ParamName,
...
{$ENDIF}
          End
          Else
            SendParamsData.AddFormField(DWParams.Items[I].ParamName,
              DWParams.Items[I].ToJSON);
        End;
      End;
    End;
  End;
  ...
  Begin
    ...
    Else If TpRequest = trHttps Then
      vTpRequest := 'https';
    If (aDataRoute = '') Then
      Result := lowercase(Format(UrlBaseA, [vTpRequest, Host, Port, '/'])) +
        EventData
    Else
...
{$ELSE}
    vResultParams := TStringStream.Create(''{$IF CompilerVersion > 21},
      TEncoding.UTF8{$IFEND});
{$ENDIF}
    Try
      HttpRequest.UserAgent := UserAgent;
      ...
      Case EventType Of
        seGET, seDELETE:
          Begin
            ...
            vURL := Url + '?';
            If WelcomeMessage <> '' Then
              vURL := vURL + BuildValue('dwwelcomemessage',
                EncodeStrings(WelcomeMessage{$IFDEF FPC},
                DatabaseCharSet{$ENDIF}));
            If (AccessTag <> '') Then
              vURL := vURL + BuildValue('dwaccesstag',
                EncodeStrings(AccessTag{$IFDEF FPC}, DatabaseCharSet{$ENDIF}));
            ...
            Begin
              ...
              End;
            End;
            vURL := vURL + BuildValue('datacompression',
              BooleanToString(Datacompress));
            vURL := vURL + BuildValue('dwassyncexec',
              BooleanToString(Assyncexec));
            vURL := vURL + BuildValue('dwencodestrings',
              BooleanToString(EncodedStrings));
            vURL := vURL + BuildValue('binaryrequest',
              BooleanToString(BinaryRequest));
            If aBinaryCompatibleMode Then
              vURL := vURL + BuildValue('BinaryCompatibleMode',
                BooleanToString(aBinaryCompatibleMode));
            vURL := Format('%s&%s', [vURL, GetParamsValues(Params{$IFDEF FPC},
              DatabaseCharSet{$ENDIF})]);
            If Assigned(vCripto) Then
              vURL := vURL + BuildValue('dwusecript',
                BooleanToString(vCripto.Use));
{$IFDEF FPC}
            aStringStream := TStringStream.Create('');
{$ELSE}
            aStringStream := TStringStream.Create(''{$IF CompilerVersion > 21},
              TEncoding.UTF8{$IFEND});
{$ENDIF}
            Case EventType Of
              seGET:
                HttpRequest.Get(vURL,
                  TStringList(HttpRequest.DefaultCustomHeader), aStringStream);
              seDELETE:
                Begin
{$IFDEF FPC}
                  TIdHTTPAccess(HttpRequest).DoRequest(Id_HTTPMethodDelete,
                    vURL, SendParams, aStringStream, []);
{$ELSE}
{$IFDEF OLDINDY}
...
{$ENDIF}
          ...
          End;
        sePOST, sePUT, sePATCH:
          Begin;
            SendParams := TIdMultipartFormDataStream.Create;
            If WelcomeMessage <> '' Then
              SendParams.AddFormField('dwwelcomemessage',
                EncodeStrings(WelcomeMessage{$IFDEF FPC},
                DatabaseCharSet{$ENDIF}));
            If AccessTag <> '' Then
              SendParams.AddFormField('dwaccesstag',
                EncodeStrings(AccessTag{$IFDEF FPC}, DatabaseCharSet{$ENDIF}));
            If ServerEventName <> '' Then
            Begin
            ...
            // End;
            // End;
            SendParams.AddFormField('datacompression',
              BooleanToString(Datacompress));
            SendParams.AddFormField('dwassyncexec',
              BooleanToString(Assyncexec));
            SendParams.AddFormField('dwencodestrings',
              BooleanToString(EncodedStrings));
            SendParams.AddFormField('binaryrequest',
              BooleanToString(BinaryRequest));
            If AuthenticationOptions.AuthorizationOption <> rdwAONone Then
            Begin
              If Assigned(Params) Then
                      ...
                      Begin
                        ...
                        Begin
                          ...
                          Try
                            vDWParam.Encoded := True;
                            vDWParam.ObjectDirection := odIN;
                            vDWParam.ParamName := TRESTDWAuthOptionBearerClient
                              (AuthenticationOptions.OptionParams).Key;
                            vDWParam.SetValue
                              (TRESTDWAuthOptionBearerClient
                              (AuthenticationOptions.OptionParams).Token,
            ...
            If aBinaryCompatibleMode Then
              SendParams.AddFormField('BinaryCompatibleMode',
                BooleanToString(aBinaryCompatibleMode));
            If Assigned(vCripto) Then
              SendParams.AddFormField('dwusecript',
                BooleanToString(vCripto.Use));
            If Params <> Nil Then
              ...
              If Not BinaryRequest Then
                While HttpRequest.DefaultCustomHeader.IndexOfName
                  ...
                  HttpRequest.DefaultCustomHeader.Delete
                    (HttpRequest.DefaultCustomHeader.IndexOfName
                    ('binaryrequest'));
...
{$ENDIF}
                Case EventType Of
                  sePUT:
                    HttpRequest.Put(Url,
                      TStringList(HttpRequest.DefaultCustomHeader), SendParams,
                      aStringStream);
                  sePATCH:
                    Begin
{$IFNDEF OLDINDY}
...
{$ENDIF}
            ...
            Begin
              ...
              Begin
                ...
                If Datacompress Then
                  vDataPack :=
                    BytesToString(StreamToBytes(TMemoryStream(StringStream)))
                Else
...
{$ENDIF}
    ...
    Except
      ...
      Begin
        ...
        If Pos(Uppercase(cInvalidInternalError), Uppercase(vErrorMessageA)
          ) = 0 Then
        Begin
          vErrorMessage := Trim(vErrorMessageA);
          vErrorMessage := StringReplace(vErrorMessage, '\\', '\',
            [rfReplaceAll]);
          If Pos(IntToStr(E.ErrorCode), vErrorMessage) > 0 Then
          Begin
            Delete(vErrorMessage, 1, Pos(IntToStr(E.ErrorCode), vErrorMessage) +
              Length(IntToStr(E.ErrorCode)));
        ...
        Begin
          ...
          Case AuthenticationOptions.AuthorizationOption Of
            rdwAOBearer:
              Begin
                If (TRESTDWAuthOptionBearerClient
                  (AuthenticationOptions.OptionParams).AutoGetToken) And
                  (TRESTDWAuthOptionBearerClient
                  (AuthenticationOptions.OptionParams).Token <> '') Then
                  TRESTDWAuthOptionBearerClient
                    (AuthenticationOptions.OptionParams).Token := '';
...
Begin
  ...
  If (Params.ItemsString['BinaryCompatibleMode'] <> Nil) Then
    aBinaryCompatibleMode := Params.ItemsString['BinaryCompatibleMode']
      .AsBoolean And aBinaryRequest;
  ...
  SetParams(ProxyOptions, RequestTimeout, ConnectTimeOut,
...
{$ENDIF}
    End;
  If aBinaryCompatibleMode Then
    If HttpRequest.DefaultCustomHeader.IndexOfName('BinaryCompatibleMode')
      = -1 Then
    Begin
{$IFNDEF FPC}
{$IF CompilerVersion > 30}
...
{$ENDIF}
  ...
  LastErrorCode := -1;
  Try
    If Not ExecRequest(EventType, vURL, WelcomeMessage, AccessTag, Encoding,
      DataCompression, EncodedStrings, aBinaryRequest, Result,
      vErrorMessage) Then
    Begin
      If FailOver Then
      Begin
        ...
        Begin
          ...
          If ExecRequest(EventType, vURL, FailOverConnections[I].WelcomeMessage,
            FailOverConnections[I].AccessTag, FailOverConnections[I].Encoding,
            FailOverConnections[I].Compression,
            FailOverConnections[I].hEncodeStrings, BinaryRequest, Result,
            vErrorMessage) Then
          Begin
