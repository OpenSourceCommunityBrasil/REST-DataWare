...
uses  Web.WebReq, Server.Containner;
...
begin
  ...
  DSHTTPWebDispatcher1.Server := server.Containner.RESTDWServer.DSServer;
  if RESTDWServer.DSServer.Started then
  begin
    DSHTTPWebDispatcher1.DbxContext := RESTDWServer.DSServer.DbxContext;
