...
{$ENDIF}
    ...
    Try
      ZCompressStream(Utf8Stream, Value, clfastest);
      Value.Position := 0;
      Result := True;
    Finally
...
function StreamToHex(Stream: TStream; QQuoted: Boolean): String;
{$IFDEF POSIX} //Android}
...
{$ENDIF}
    Try
      ZCompressStream(Utf8Stream, Result, clfastest);
      Result.Position := 0;
    Finally
...
{$ENDIF}
  Try
    ...
    Try
      ZCompressStream(Utf8Stream, Compressed, clfastest);
